...
export default function Index() {
  ...
  return (
    <div className="space-y-32 pb-32">
      ...
      <section id="our-services" className="mx-auto w-full max-w-7xl px-6 lg:px-10">
        <div className="px-6 py-12 lg:px-12">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-[hsl(var(--secondary))] sm:text-4xl">
